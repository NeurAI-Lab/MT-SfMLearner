...
#
cfg.model.loss.altitude_with_gps = True         # Whether GPS altitude is available when using G2S loss
#
...
cfg.model.depth_net.attack = False              # Set to true when attacking
########################################################################################################################
### MODEL.POSE_NET
########################################################################################################################
...
# Order of depth, pose
cfg.datasets.augmentation.mim_strategy = ['',
                                          '']
                                                            # MIM Masking strategy ["random", "blockwise"]
cfg.datasets.augmentation.mim_mask_size = [16, 16]          # MIM mask size (must be product of patch size)
cfg.datasets.augmentation.mim_mask_ratio = [0.25, 0.25]
                                                            # MIM mask ratio
cfg.datasets.augmentation.mim_common = ''                   # Common (first) mask on ['all', 'pose', '']
