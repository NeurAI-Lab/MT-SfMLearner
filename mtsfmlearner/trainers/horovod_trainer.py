...
from mtsfmlearner.trainers.base_trainer import BaseTrainer, sample_to_cuda
from mtsfmlearner.utils.config import prep_logger_and_checkpoint
from mtsfmlearner.utils.logging import print_config
from mtsfmlearner.utils.logging import AvgMeter
...
class HorovodTrainer(BaseTrainer):
    ...
    def fit(self, module):
        ...
        for epoch in range(module.current_epoch, self.max_epochs):
            # Train
            self.train(train_dataloader, module, depth_optimizer, pose_optimizer)
            # Validation
