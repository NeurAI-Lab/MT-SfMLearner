...
from mtsfmlearner.utils.depth import load_depth
from tqdm import tqdm

from mtsfmlearner.utils.depth import load_depth, compute_depth_metrics


def parse_args():
    """Parse arguments for benchmark script"""
    parser = argparse.ArgumentParser(description='MT-SfMLearner benchmark script')
